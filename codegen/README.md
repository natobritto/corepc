...
Starting from Bitcoin Core v30, the `bitcoin-cli api` command outputs an OpenRPC document
that describes all available RPC methods and their input/output schemas.
