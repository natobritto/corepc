...
pub use crate::{
    ...
    v24::{
        ...
        GetMempoolEntry, GetMempoolInfo, GetPeerInfo, GetRawMempoolSequence, GetRawMempoolVerbose,
        GetTransaction, GetTransactionDetail, GetTransactionError, GetTxSpendingPrevout,
        GetTxSpendingPrevoutError, GetTxSpendingPrevoutItem, GlobalXpub, GlobalXpubError,
        ListSinceBlock, ListSinceBlockError, ListTransactions, ListUnspent, ListUnspentItem,
        MempoolEntry, MigrateWallet, PeerInfo, Proprietary, PsbtInput, PsbtInputError, PsbtOutput,
        ...
        TaprootScriptPathSig, TaprootScriptPathSigError, TransactionItem, TransactionItemError,
    },
};
