...
pub use crate::{
    ...
    v24::{
        ...
        GetMempoolDescendantsVerbose, GetMempoolEntry, GetRawMempoolSequence, GetRawMempoolVerbose,
        GetTransactionDetail, GetTxSpendingPrevout, GetTxSpendingPrevoutError,
        GetTxSpendingPrevoutItem, ListUnspent, ListUnspentItem, MempoolEntry, MigrateWallet,
        SendAll, SendAllError, SimulateRawTransaction,
    },
    v25::{
